...
// 称号図鑑の一覧表示（進捗バー＋カテゴリ別グリッド）。
// 自分の称号図鑑・他メンバーのプロフィールモーダルの両方から使う。
function TitlesCollection({ titles }) {
              ...
              {list.map((title) => (
                ...
                >
                  ...
                  <div className="title-card__body">
                    ...
                    {title.description && <p className="title-card__desc">{title.description}</p>}
                  </div>
                </li>
              ))}
            </ul>
...
export default TitlesCollection
